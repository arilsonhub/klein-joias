...
http.setRequestHeader("Content-length", dados_a_enviar.length); //Cabeçalho informando o Tamanho das informações passadas para requisição
http.setRequestHeader("Connection", "close"); //Cabeçalho informando para fechar conexão
}
